...
from datasets_test.1212 import 1212
...
#         ape_logits = R_fW + cache_logits * cfg['best_alpha']
        ...
        predicted_labels = [str(label) for label in predicted_labels]  # 리스트의 각 요소를 문자열로 변환
...
def main():
    ...
    result = test(cfg, cache_keys, cache_values, test_features, clip_weights, cls)
